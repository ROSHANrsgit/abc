          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            <div className="mb-6">
              ...
              <input
                ...
                className="mt-1 block outfit-medium w-full px-3 py-2 bg-white dark:bg-gray-700 border dark:border-gray-600 rounded-sm  focus:outline-none border-[#9DDE8B] focus:border-[#9DDE8B] sm:text-sm"
              />
            </div>
            <div className="mb-6">
              <label className="block text-sm outfit-medium text-gray-700 dark:text-gray-400">
            ...
            <div className="mb-6">
              ...
              <select
                ...
                onChange={handleChange}
                className="mt-1 block w-full outfit-medium px-3 py-2 bg-white dark:bg-gray-700 border   dark:border-gray-600 rounded-sm   focus:outline-none  border-[#9DDE8B] focus:border-[#9DDE8B] sm:text-sm"
              >
            ...
            <div className="mb-6">
              ...
              <select
                ...
                onChange={handleChange}
                className="mt-1 block w-full px-3 py-2 outfit-medium bg-white dark:bg-gray-700 border   dark:border-gray-600 rounded-sm   focus:outline-none  border-[#9DDE8B] focus:border-[#9DDE8B] sm:text-sm"
              >
            ...
            <div className="mb-6">
              ...
              <select
                ...
                onChange={handleChange}
                className="mt-1 block w-full px-3 outfit-medium py-2 bg-white dark:bg-gray-700 border   dark:border-gray-600 rounded-sm   focus:outline-none  border-[#9DDE8B] focus:border-[#9DDE8B] sm:text-sm"
              >
